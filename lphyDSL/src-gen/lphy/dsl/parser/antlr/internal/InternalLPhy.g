...
entryRuleLPhyModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLPhyModelRule()); }
	iv_ruleLPhyModel=ruleLPhyModel
	{ $current=$iv_ruleLPhyModel.current; }
	EOF;

// Rule LPhyModel
ruleLPhyModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleLawNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLawNodeRule()); }
	iv_ruleLawNode=ruleLawNode
	{ $current=$iv_ruleLawNode.current; }
	EOF;

// Rule LawNode
ruleLawNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_InstantiatedDistribution_0.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleInstantiatedDistribution returns [EObject current=null]:
	...
	{ $current=$iv_ruleInstantiatedDistribution.current; }
	EOF;

// Rule InstantiatedDistribution
ruleInstantiatedDistribution returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDistributionTypeSpecification returns [EObject current=null]:
	...
	{ $current=$iv_ruleDistributionTypeSpecification.current; }
	EOF;

// Rule DistributionTypeSpecification
ruleDistributionTypeSpecification returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			...
			{
				$current = $this_JavaDist_1.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		(
			...
			{
				$current = $this_LPhyDist_3.current;
				afterParserOrEnumRuleCall();
			}
		)
	)
...
entryRuleLPhyDist returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLPhyDistRule()); }
	iv_ruleLPhyDist=ruleLPhyDist
	{ $current=$iv_ruleLPhyDist.current; }
	EOF;

// Rule LPhyDist
ruleLPhyDist returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleJavaDist returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getJavaDistRule()); }
	iv_ruleJavaDist=ruleJavaDist
	{ $current=$iv_ruleJavaDist.current; }
	EOF;

// Rule JavaDist
ruleJavaDist returns [EObject current=null]
@init {
	enterRule();
}
@after {
