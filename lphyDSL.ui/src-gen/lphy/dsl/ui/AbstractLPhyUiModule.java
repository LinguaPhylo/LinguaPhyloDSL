...
import lphy.dsl.ide.contentassist.antlr.LPhyParser;
import lphy.dsl.ide.contentassist.antlr.PartialLPhyContentAssistParser;
import lphy.dsl.ide.contentassist.antlr.internal.InternalLPhyLexer;
import lphy.dsl.ui.contentassist.LPhyProposalProvider;
import lphy.dsl.ui.editor.LPhyEditor;
import lphy.dsl.ui.labeling.LPhyDescriptionLabelProvider;
import lphy.dsl.ui.labeling.LPhyLabelProvider;
import lphy.dsl.ui.outline.LPhyOutlineTreeProvider;
import lphy.dsl.ui.quickfix.LPhyQuickfixProvider;
import lphy.dsl.validation.LPhyValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link LPhyUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractLPhyUiModule extends DefaultXbaseUiModule {

	public AbstractLPhyUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(lphy.dsl.parser.antlr.internal.InternalLPhyLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return LPhyParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalLPhyLexer.class).toProvider(LexerProvider.create(InternalLPhyLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return LPhyValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return LPhyLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(LPhyDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return LPhyOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return LPhyQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return LPhyProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialLPhyContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("LPhy Compare");
	}
