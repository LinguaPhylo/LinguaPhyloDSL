 ...
 */
package lphy.dsl.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import lphy.dsl.ide.contentassist.antlr.internal.InternalLPhyParser;
import lphy.dsl.services.LPhyGrammarAccess;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class LPhyParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(LPhyGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LPhyGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getDistributionTypeSpecificationAccess().getAlternatives(), "rule__DistributionTypeSpecification__Alternatives");
			...
			builder.put(grammarAccess.getLPhyModelAccess().getGroup(), "rule__LPhyModel__Group__0");
			builder.put(grammarAccess.getLPhyModelAccess().getGroup_1(), "rule__LPhyModel__Group_1__0");
			builder.put(grammarAccess.getLPhyModelAccess().getGroup_5(), "rule__LPhyModel__Group_5__0");
			builder.put(grammarAccess.getLPhyModelAccess().getGroup_5_2(), "rule__LPhyModel__Group_5_2__0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getGroup(), "rule__InstantiatedDistribution__Group__0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getGroup_2(), "rule__InstantiatedDistribution__Group_2__0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getGroup_2_1(), "rule__InstantiatedDistribution__Group_2_1__0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getGroup_2_1_1(), "rule__InstantiatedDistribution__Group_2_1_1__0");
			...
			builder.put(grammarAccess.getRangeAccess().getGroup_1(), "rule__Range__Group_1__0");
			builder.put(grammarAccess.getDistributionTypeSpecificationAccess().getGroup_0(), "rule__DistributionTypeSpecification__Group_0__0");
			builder.put(grammarAccess.getDistributionTypeSpecificationAccess().getGroup_1(), "rule__DistributionTypeSpecification__Group_1__0");
			...
			builder.put(grammarAccess.getLPhyModelAccess().getPackageAssignment_1_1(), "rule__LPhyModel__PackageAssignment_1_1");
			builder.put(grammarAccess.getLPhyModelAccess().getImportSectionAssignment_2(), "rule__LPhyModel__ImportSectionAssignment_2");
			builder.put(grammarAccess.getLPhyModelAccess().getNameAssignment_4(), "rule__LPhyModel__NameAssignment_4");
			builder.put(grammarAccess.getLPhyModelAccess().getParametersAssignment_5_1(), "rule__LPhyModel__ParametersAssignment_5_1");
			builder.put(grammarAccess.getLPhyModelAccess().getParametersAssignment_5_2_1(), "rule__LPhyModel__ParametersAssignment_5_2_1");
			builder.put(grammarAccess.getLPhyModelAccess().getLawNodesAssignment_7(), "rule__LPhyModel__LawNodesAssignment_7");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getGeneratedVariablesAssignment_0(), "rule__InstantiatedDistribution__GeneratedVariablesAssignment_0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getTypeSpecAssignment_1(), "rule__InstantiatedDistribution__TypeSpecAssignment_1");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getExplicitArgumentsAssignment_2_0(), "rule__InstantiatedDistribution__ExplicitArgumentsAssignment_2_0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getArgumentsAssignment_2_1_0(), "rule__InstantiatedDistribution__ArgumentsAssignment_2_1_0");
			builder.put(grammarAccess.getInstantiatedDistributionAccess().getArgumentsAssignment_2_1_1_1(), "rule__InstantiatedDistribution__ArgumentsAssignment_2_1_1_1");
			...
			builder.put(grammarAccess.getVariableAccess().getRangeAssignment_1_1(), "rule__Variable__RangeAssignment_1_1");
			builder.put(grammarAccess.getRangeAccess().getStartAssignment_0(), "rule__Range__StartAssignment_0");
			builder.put(grammarAccess.getRangeAccess().getEndAssignment_1_1(), "rule__Range__EndAssignment_1_1");
			builder.put(grammarAccess.getLPhyDistAccess().getDistributionTypeAssignment(), "rule__LPhyDist__DistributionTypeAssignment");
			builder.put(grammarAccess.getJavaDistAccess().getDistributionTypeAssignment(), "rule__JavaDist__DistributionTypeAssignment");
	...
	@Override
	protected InternalLPhyParser createParser() {
		InternalLPhyParser result = new InternalLPhyParser(null);
